    ...
    <Box>
      <Grid container spacing={2}>
        ...
        <Grid item xs={12} sm={4}>
          <Select
            {...getFieldProps(PETTY_CASH_FORM_KEY.VENDOR_CODE)}
            errorMessage={_getErrorMessage(PETTY_CASH_FORM_KEY.VENDOR_CODE)}
            onBlur={setFieldTouched}
            label={'Vendor Code'}
            placeholder={'Search'}
            extraRequired
        ...
        <Grid item xs={12} sm={6}>
          <TextareaAutosize
            ...
            errorMessage={_getErrorMessage(PETTY_CASH_FORM_KEY.VENDOR_ADDRESS)}
            {...getUncontrolledFieldProps(PETTY_CASH_FORM_KEY.VENDOR_ADDRESS)}
            disabled
            minRows={2}
          />
        </Grid>
        ...
        <Grid item xs={12} sm={8}>
          <Input
            ...
            errorMessage={_getErrorMessage(PETTY_CASH_FORM_KEY.PROJECT_CONTACT)}
            {...getUncontrolledFieldProps(PETTY_CASH_FORM_KEY.PROJECT_CONTACT)}
        ...
        <Grid item xs={12} sm={4}>
          <InputUSPhone
            label={'Phone Number'}
            errorMessage={_getErrorMessage(PETTY_CASH_FORM_KEY.PROJECT_CONTACT_PHONE)}
            {...getFieldProps(PETTY_CASH_FORM_KEY.PROJECT_CONTACT_PHONE)}
